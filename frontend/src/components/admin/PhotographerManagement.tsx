...
const PhotographerManagement: React.FC = () => {
  ...
  const fetchPhotographers = async () => {
    try {
      setIsLoading(true);
      const response = await apiService.getPhotographers();
  ...
  const onSubmit = async (data: Photographer) => {
    try {
      if (editingPhotographer?._id) {
        ...
        await apiService.updatePhotographer(editingPhotographer._id, data);
        toast({
          title: "Success",
        ...
        await apiService.addPhotographer(data);
        toast({
          title: "Success",
  ...
  const handleDelete = async (id: string) => {
    if (window.confirm("Are you sure you want to delete this photographer?")) {
      try {
        await apiService.deletePhotographer(id);
        toast({
          title: "Success",
